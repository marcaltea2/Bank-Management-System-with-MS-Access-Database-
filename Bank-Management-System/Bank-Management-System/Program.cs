...
{ 
    ...
    class Program
    {
        ...
        public static void Create_Account()
        {
            ...
            Console.WriteLine("USER ACCOUNT REGISTRAION\n");
            Console.WriteLine("**********************************\n");
        ...
        {
            Console.Clear();
            Console.WriteLine("LOGIN USER ACCOUNT\n");
            Console.WriteLine("**********************************\n");
        ...
        public static void Login_admin()
        {
            ...
            Console.WriteLine("LOGIN ADMINISTRATOR ACCOUNT\n");
            Console.WriteLine("**********************************\n");
        ...
        public static void Admin_Account()
        {
            ...
            switch (input)
            {
                case "1":
                    ...
                    {
                        counter++;
                        Console.WriteLine("Account ID:     " + reader[0] + "     First Name:     " + reader[1] + "     Last Name:     " + reader[2]+ "     Available Balance:     " + reader[4]);
                    }
                    con.Close();
                ...
                case "3":
                    ...
                    Console.WriteLine("UPDATE USER ACCOUNT\n");
                    Console.WriteLine("**********************************\n");
